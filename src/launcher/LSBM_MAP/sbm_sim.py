...
from src.node_classification import LsbmMap
...
def get_methods(graph_config):
    ...
    methods = [{'name': 'lsbm_map', 'method': LsbmMap(pi=pi, pe=pe, li=li, le=le, num_classes=num_classes,
...
def run(pid):
    ...
    method_configs = get_methods(graph_config)
